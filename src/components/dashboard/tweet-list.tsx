...
import { Heart, Bookmark, BarChart2, ExternalLink, MessageCircle, Quote, Repeat, BadgeCheck } from "lucide-react"
        ...
        {tweets.map((tweet) => (
          <Card key={tweet.tweet_id}>
            <CardContent className="pt-4">
              ...
              <p className="mb-4">{tweet.text.slice(0, 100)}{tweet.text.length > 100 ? '...' : ''}</p>
              ...
              <div className="flex justify-between items-end space-x-2">
                ...
                <Link href={tweet.url} target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-blue-500 hover:underline">
                  View Tweet
